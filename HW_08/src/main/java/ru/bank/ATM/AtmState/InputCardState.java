...
public class InputCardState extends AtmState {
    ...
    public void doAction(AtmContext context) {
        displayMenuMessage(MenuMessages.INSERT_BANK_CARD, context.getATM().getAtmName());
        ...
        if (BankCard.validateCardNumber(inputLine)) {
            ...
            displayMenuMessage(MenuMessages.CARD_IS_NOT_RECOGNIZED, context.getATM().getAtmName());
        }
    }
}
